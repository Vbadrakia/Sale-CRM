...
console.warn('[db-reset] WARNING: this deletes all development schema data.');
console.warn('[db-reset] Running migration rollback, then migrations and seed...');
...
run(['run', 'db:migrate:undo:all', '-w', 'backend']);
